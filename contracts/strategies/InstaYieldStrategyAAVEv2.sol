...
contract InstaYieldStrategyAAVEv2 is IInstaYieldStrategy, Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    address immutable InstaYieldProtocolAddress;
    ...
    function burnFToken(
        ...
        IInstaYieldToken(fTokenAddress).burnFrom(msg.sender, _tokenAmount);
    ...
    modifier onlyAuthorised() {
        require(msg.sender == InstaYieldProtocolAddress || msg.sender == address(this), "NOT FLASH PROTOCOL");
        _;
    }
